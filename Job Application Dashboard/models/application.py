...
class Application:
    ...
    # Status colors
    STATUS_COLORS = {
        STATUS_APPLIED: "#3B82F6",       # blue-500
        STATUS_INTERVIEWING: "#F59E0B",  # amber-500
        STATUS_OFFER: "#10B981",        # emerald-500
        STATUS_REJECTED: "#EF4444",     # red-500
    }
    
    def __init__(self, company, role, date_applied, status, location=None, notes=None, id=None, 
