...
def project_player_stats(
    ...
    avg_min, std_min = _calculate_weighted_average(minutes, config.recency_weight)
    avg_pts, std_pts = _calculate_weighted_average(pts, config.recency_weight)
    avg_reb, std_reb = _calculate_weighted_average(reb, config.recency_weight)
    avg_ast, std_ast = _calculate_weighted_average(ast, config.recency_weight)
    ...
    proj_pts = avg_pts * adj_factor
    proj_reb = avg_reb * adj_factor
    proj_ast = avg_ast * adj_factor
