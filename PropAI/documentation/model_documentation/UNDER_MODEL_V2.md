...
> **⚠️ NOTICE:** This document describes the standalone Under Model V2. For the latest 
> integrated approach, see **Model V16** which combines general and under models with 
> hybrid line handling and achieved 72.4% overall hit rate (70.5% on PTS UNDER specifically).
> The V16 Under Model placeholder (`model_v16_under.py`) is designed to extend this approach.
