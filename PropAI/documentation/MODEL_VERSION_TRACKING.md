...
## Current Best Models: V16.1 + V16.5

### V16.1 General (OVER + B2B UNDER)
- **72.4% hit rate** overall
- Primary patterns: **Cold Bounce** (76.9%), **B2B Fatigue** (75.0%)
- See: `documentation/MODEL_V16.md`

### V16.5 Under (Factor-Based UNDER)
- **60.6% overall**, **84.6% PREMIUM tier**
- Combines multiple factors: defense, cold streak, B2B, injury rust
- See: `documentation/MODEL_V16_UNDER.md`

### GUI Integration
Both models run together in the Model Performance tab and Matchups tab. Picks are labeled with their source (`V16 General` or `V16 Under`).
