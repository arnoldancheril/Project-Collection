...
| Model | Hit Rate | Picks/Day | Notes |
|-------|----------|-----------|-------|
| **Model V16.1** | **72.4%** | **2.9** | **CURRENT PRODUCTION - Hybrid lines** |
| Model Production | 66.7% | 5-8 | Pattern-based |
| Hybrid v1.2 | 66.6% | 7.2 | Contribution rates |
| RCM v1.4 | 60.4% | 10-15 | Original contribution model |

**Note:** Model V16.1 represents a significant advancement over the Hybrid Model,
achieving 72.4% hit rate by solving the "Derived Line Fallacy" through hybrid
line handling (sportsbook when available, derived with stricter thresholds when not).

See `MODEL_V16.md` for the current recommended production model.
